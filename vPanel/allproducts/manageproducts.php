...
?>
        ...
        <div class="row">
          <div class="col-xs-12 well">
				...
				<h4><a href="../itemadd/additem.php"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#addadminprofile">
                Add New Item
              </button></a>
              </h4>
